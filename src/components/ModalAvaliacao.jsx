...
  const [reviewText, setReviewText] = useState('');
  ...
  const handleRemoveImage = (indexToRemove) => {
    ...
    URL.revokeObjectURL(imageToRemove.previewUrl); // Limpa a URL da memória
...
    });
    //alert para mostrar que tá funcionado, será mudado dps
...
          <button
            type="submit"
            className="w-full rounded-lg bg-[#FD7702] py-3 text-lg font-bold text-white hover:bg-[#e66a00] transition-colors"
          >
            Postar
          </button>
        </form>
