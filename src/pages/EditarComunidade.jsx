              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                ...
                <div className="flex justify-center">
                  <button
                    onClick={handleSave}
                    disabled={isSaving}
                    className={`cursor-pointer bg-[#FD7702] text-white font-bold py-3 px-12 rounded-lg hover:bg-[#e66a00] transition-colors shadow-md w-full md:w-auto text-center flex items-center justify-center gap-2 ${isSaving ? 'opacity-70 cursor-not-allowed' : ''}`}
                  >
                    {isSaving ? (
                      <>
