        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex gap-4 mb-6">
            <button
              ...
              className={`w-full py-3 px-4 rounded-lg font-bold transition duration-300 ${tipoCadastro === "usuario"
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-lg font-bold transition duration-300 ${tipoCadastro === "empresa"
                  ? "bg-[#FD7702] text-white"
                  : "bg-gray-300 text-gray-700"
                }`}
            >
